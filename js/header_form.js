...
html += '<!--div id="header-entry"><a href="entry.html" target="_blank">ENTRY</a></div-->';
...
html += '<a href="https://www.youtube.com/channel/UCQ---C7yaBpjyMjDROYVTqg" target="_blank"><img src="../images/youtube_40.png" class="komerilogo" alt="youtube" /></a>';
html += '</div>';
